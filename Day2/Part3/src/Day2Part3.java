...
public class Day2Part3 {
    ...
    public static void main(String[] args) {
        ...
        try {
            myReader = new BufferedReader(new FileReader(Path.of("Day2\\Part3\\src\\Input.txt").toString()));
            ...
            for (Long x = 0L; x < 1001; x++){
                for (Long y = 0L; y < 1001; y++){
                    curincr = new Long[]{x, y};
                    point = add(A, curincr);
                    if (isEngraved(point)){
                        count++;
                    }
